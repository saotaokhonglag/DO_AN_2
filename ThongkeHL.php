                ...
                <div class="table-responsive">
                    <table class="table table-bordered" style = "text-align: center;" id="dataTable" width="100%" cellspacing="0">
                        ...
                        if(isset($_POST['thongke'])){
                            ...
                            if($gethocluc=="gioi"){
                                $STT = 1;
                    $sql = $conn-> query("SELECT sv.MSSV, ct.MaLopHP, ct.DiemGK, ct.DiemCK, ct.DIemTB 
                    FROM sinhvien sv, chitietmh ct WHERE sv.MSSV = ct.MSSV and ct.DiemTB>='8.5' AND ct.DIemTB<=10 AND ct.MaLopHP='$getmalop'");
                            }
                            if($gethocluc=="kha"){
                                $STT = 1;
                    $sql = $conn-> query("SELECT sv.MSSV, ct.MaLopHP, ct.DiemGK, ct.DiemCK, ct.DIemTB 
                    FROM sinhvien sv, chitietmh ct WHERE sv.MSSV = ct.MSSV and ct.DiemTB>=7 AND ct.DIemTB<='8.4'AND ct.MaLopHP='$getmalop'");
                            }
                            if($gethocluc=="tb"){
                                $STT = 1;
                    $sql = $conn-> query("SELECT sv.MSSV, ct.MaLopHP, ct.DiemGK, ct.DiemCK, ct.DIemTB 
                    FROM sinhvien sv, chitietmh ct WHERE sv.MSSV = ct.MSSV and ct.DiemTB>='5.5' AND ct.DIemTB<='6.9'AND ct.MaLopHP='$getmalop'");
                            }
                            if($gethocluc=="yeu"){
                                $STT = 1;
                    $sql = $conn-> query("SELECT sv.MSSV, ct.MaLopHP, ct.DiemGK, ct.DiemCK, ct.DIemTB 
                    FROM sinhvien sv, chitietmh ct WHERE sv.MSSV = ct.MSSV and ct.DiemTB>=4 AND ct.DIemTB<='5.4'AND ct.MaLopHP='$getmalop'");
                            }
