...
// Hiển thị danh sách
    $sql = $conn -> query("SELECT ct.MSSV, sv.HoVaTen, sv.Lop, ct.DiemGK, ct.DiemCK, ct.DIemTB ,lh.TenLop
...
<head>
    ...
    <title>Điểm trung bình học phần</title>
...
<!-- Bắt đầu phần nội dung -->
 ...
 <!-- Combobox điểm -->
<form class="user" method="POST" action ="DiemTB.php">
        ...
        <?php
                    $CbGV = $conn -> query("SELECT lh.MaLopHP, lh.TenLop
                                            ...
                                            WHERE gv.MaGV = pc.MaGV AND 
                                                  ...
                                                  gv.MaGV = '$username'" );
        ?>
          <label style = "font-weight: bold; margin-left: 40px;">Chọn lớp học phần để xem điểm trung bình:</label>
        ...
        <?php if($Seleted == true):?>
            <div class="container-fluid">
                ...
                <div class="card-header py-3" style = "text-align: center;" >
                    <h5 class="m-0 font-weight-bold text-primary">Điểm trung bình lớp học phần <?php echo $MaLopHP; ?> </h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" style = "text-align: center;" id="dataTable" width="100%" cellspacing="0">
                                <tr>    
                                        ...
                                        <th>Họ và tên</th>
                                        <th>Lớp</th>
                                        <th colspan="2">Điểm giữa kì</th> 
                                        <th colspan="2">Điểm cuối kì </th> 
                            ...
                            <?php
                                ...
                                <tr>
                                    <th><?php echo $STT++;?> </th>
                                    <th><?php echo $rows['MSSV'];?> </th>
                                    <th><?php echo $rows['HoVaTen'];?> </th>
                                    <th><?php echo $rows['Lop'];?> </th>
...
{       $MSSV = $_POST['MaSV'];
     ...
     for($i = 0; $i < $length; $i++)
     {
         ...
         $a_Diem = $GiuaKi[$i];
         $a_LopHP = $MaLHP[$i];
         $conn ->query("UPDATE chitietmh SET DiemGK='$a_Diem' WHERE MSSV = '$a_MSSV' AND MaLopHP = '$a_LopHP'");                
     }
