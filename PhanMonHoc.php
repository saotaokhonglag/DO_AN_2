...
<div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                  ...
                  <?php
                        $STT = 1;
                        $result = $conn->query("SELECT pc.MaLopHP, hp.TenLop, gv.TenGV, pc.HocKi, pc.NamHoc
                                                FROM phancong pc, giangvien gv, lophp hp
                                                WHERE pc.MaGV = gv.MaGV AND hp.MaLopHP = pc.MaLopHP") or die($conn->error);
                        //  Bắt đầu vòng lặp
                        ...
                        <tr>
                            ...
                            <td> 
                            <a href="PhanCongGV.php?edit=<?php echo $row['MaLopHP']; ?>" class="btn btn-primary" > Sửa </a>                      
                            </td>
                        </tr>
                        </tbody>
                  <?php endwhile; ?>   
    ...
    <div style = "text-align: center;">
      <a href="PhanCongGV.php"><input type="button" value="Phân công" class = "btn btn-primary" style="height: 40px; width: 95px;"/></a>  
    </div>   
<!-- Kết thúc BODDY -->
