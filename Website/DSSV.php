...
if(mysqli_num_rows($sql)>0)
{
  // Lấy họ tên 
    ...
    {
        $HocPhan = $_GET['DS'];
        $sql = $conn -> query("SELECT * FROM phancong pc, lophp hp WHERE hp.MaLopHP = pc.MaLopHP AND pc.MaLopHP = '$HocPhan'");
        if(mysqli_num_rows($sql)>0)
        {
        // Lấy họ tên 
            $row = $sql->fetch_assoc();
       ...
       <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3" style = "text-align: center;" >
                <h5 class="m-0 font-weight-bold text-primary">Danh sách lớp học phần <?php echo $Ten;?> </h5>
                <h7 class="m-0 font-weight-bold text-primary"> Học kì: <?php echo $Hoc;?> </h7> </br>
                <h7 class="m-0 font-weight-bold text-primary"> Năm học: <?php echo $Nam;?> </h7>     
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" style = "text-align: center;" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                            $STT = 1;
                            $sql = $conn ->query("SELECT sv.MSSV, sv.HoVaTen,  sv.Lop, sv.Khoa, sv.GioiTinh, sv.NgaySinh
