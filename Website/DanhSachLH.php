...
<head>
    ...
    <script>
        $(document).ready(function(){
          ...
          <?php require_once 'php/LopHP.php'; ?>
</head>
<body id="page-top">
...
<div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Danh sách lớp học phần</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" style = "text-align: center;" id="dataTable" width="100%" cellspacing="0">
                        <tr>
                            ...
                            <?php
                 $STT = 1;
                 $sql = $conn -> query("SELECT * FROM lophp");
                //  Bắt đầu vòng lặp
                while($row = $sql-> fetch_assoc()): ?>
                <tr>
                    <td> <?php echo $STT++;?> </td>
                    <td><?php echo $row['MaLopHP']; ?></td>
                    <td><?php echo $row['TenLop']; ?></td>
                    
                    <td> 
                      <a class='btn btn-info btn-sm' href='DanhSachLH.php?sua=<?php echo $row['MaLopHP']; ?>'> <i class='fas fa-pencil-alt'> </i> Sửa </a>
                    </td>
                </tr>
                <?php endwhile?>
                    </table>
  ...
  <!-- NÚT THÊM GIẢNG VIÊN -->
    <table style="margin-top: 300px;">
                 <a class="collapse-item"  style="padding-left: 550px;">Thêm lớp học phần</a>
            <form class="user" method="POST" action ="php/LopHP.php">
                <div class="form-group row">
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-user" id="maGV"
                            placeholder="Mã Lớp học phần" name="malop" value= "<?php echo $Malop;?>" <?php if($update == true){echo 'readonly';}?> style="margin-left: 100px;">
                    </div>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-user" id="Hoten"
                            placeholder="Tên lớp" name="tenlop" value= "<?php echo $Tenlop;?>" style="margin-left: 100px" >
                    </div>
                </div>
                    <div>
                <!-- Sự kiện nút sửa và xóa  -->
                <?php
               if($update == true):?>
                  <button type = "submit" name = "sua" style="margin-left: 600px;"> Sửa </button>
               <?php else: ?>
                  <button type = "submit" name = "them"  class = "btn btn-primary" style="margin-left: 500px;"> Thêm lớp học phần </button>
                <?php endif; ?> 
                    </div>
