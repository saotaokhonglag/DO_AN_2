        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="#">Giữa kì</a>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Xin chào <?php echo $HoTenSV;?></span>
...
<!-- BODY -->
    ...
    <div class="card-body">
      <form class="user" method="POST" action ="php/Password.php">
                <div class="form-group row">
                    <div class="col-sm-5">
                        <input type="password" class="form-control form-control-user" id="MK"
                            placeholder="Mật khẩu mới" name="MatKhau"  style="margin-left: 100px;">
                    </div>
                    <div class="col-sm-5">
                        <input type="password" class="form-control form-control-user" id="MKM"
                            placeholder="Nhập lại mật khẩu mới" name="MatKhauMoi" style="margin-left: 100px" >
                    </div>
                </div>
