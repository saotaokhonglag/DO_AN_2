...
// Hiển thị danh sách
    $sql = $conn -> query("SELECT ct.MSSV, sv.HoVaTen, sv.Lop, ct.DiemCK, ct.DiemGK, lh.TenLop , yc.TrangThaiYC, yc.MaYC
                            FROM giangvien gv, chitietmh ct, sinhvien sv, phancong pc, lophp lh, dsyeucau yc
...
<head>
    ...
    <title>Điểm cuối kì học phần</title>
...
<body id="page-top">
<?php require_once 'php/DuyetYC.php' ?>
    <div id="wrapper">
...
<!-- Bắt đầu phần nội dung -->
 ...
 <!-- Form chọn lớp học -->
<form class="user" method="POST" action ="DiemCK.php">
        ...
        <?php
                    $CbGV = $conn -> query("SELECT lh.MaLopHP, lh.TenLop
                                            ...
                                            WHERE gv.MaGV = pc.MaGV AND 
                                                  ...
                                                  gv.MaGV = '$username'" );
        ?>
          <label style = "font-weight: bold; margin-left: 40px;">Chọn lớp học phần để xem điểm cuối kì:</label>
                <div class="col-sm-6 mb-3 mb-sm-3" style="margin-bottom: 5px;">
                    <select name="LopHP" class="form-select" style="margin-left: 14px; width: 310px;">
                        <?php
        ...
        ?>
            <div class="container-fluid">
                ...
                <div class="card-header py-3" style = "text-align: center;" >
                    <h5 class="m-0 font-weight-bold text-primary">Điểm cuối kì lớp học phần <?php echo $MaLopHP; ?> </h5>
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <input type = "number" name = "CuoiKi[]" value = "<?php echo $rows['DiemCK'];?>" <?php if($rows['DiemCK'] != null){echo 'readonly';} ?> min = '0.0' max= '10.0' style = 'width: 55px;'>
                                     </td>
                                    <?php endif; ?>    
                                    <td>
...
<?php 
        ...
        {      
            ...
            if(mail($to_email, $subject, $body, $headers))
            {
                ...
                $conn -> query("INSERT INTO dsyeucau(MaLopHP, MaGV, NoiDung, TrangThaiYC, NgayYC) VALUES ('$HP', '$username', 'Chỉnh sửa điểm cuối kì' , 0 , '$NgayYC')");
