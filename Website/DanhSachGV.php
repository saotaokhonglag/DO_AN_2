...
<body id="page-top">
    ...
    <?php require_once 'php/GiangVien.php'; ?>
        ...
        <tr>
            ...
            <!-- Truy vấn bảng giảng viên -->
                ...
                <tr>
                    ...
                    <td> 
                      <a class='btn btn-info btn-sm' href='DanhSachGV.php?Sua=<?php echo $row['MaGV'] ?>'> <i class='fas fa-pencil-alt'> </i> Sửa </a>
                      <a class='btn btn-danger btn-sm' href='php/GiangVien.php?Xoa=<?php echo $row['MaGV'] ?>'> <i class='fas fa-trash'> </i>Xóa </a>
                    </td>
                </tr>
                ...
                <script language = "javascript">
                      function XacNhan(delid)
                      {
                          if(confirm("Bạn có muốn xóa người này ?")){
                              window.location.href = 'php/GiangVien.php?Xoa ='+delid+'';
         ...
         <!-- NÚT THÊM GIẢNG VIÊN -->
            ...
            <form class="user" method="POST" action ="php/GiangVien.php">
                <div class="form-group row">
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-user" id="maGV"
                            placeholder="Mã số" name="maso" value = "<?php echo $MaGV;?>" <?php if($update == true){echo 'readonly';} ?> style="margin-left: 100px;">
                    </div>
                    <div class="col-sm-5">
                        <input type="text" class="form-control form-control-user" id="Hoten"
                            placeholder="Họ và Tên" name="ten"  value = "<?php echo $HoTenGV;?>" style="margin-left: 100px" >
                    </div>
                </div>
                    <div>
                ...
                <?php
               if($update == true):?>
                  <button type = "submit" name = "sua" class="btn btn-primary" style="margin-left: 600px;"> Sửa </button>
               <?php else: ?>
                  <button type = "submit" name = "them" class="btn btn-primary" style="margin-left: 600px;"> Thêm </button>
                <?php endif; ?> 
                    </div>
