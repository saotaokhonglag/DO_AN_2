            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" style = "text-align: center;" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                                 $sql = $conn -> query("SELECT lh.TenLop, pc.HocKi, pc.NamHoc, yc.NoiDung, yc.TrangThaiYC, yc.NgayYC
                                            FROM dsyeucau yc, phancong pc, lophp lh, giangvien gv
                                            WHERE yc.MaGV = pc.MaGV AND pc.MaGV = gv.MaGV AND lh.MaLopHP = yc.MaLopHP AND yc.MaGV = '$username'");
                                    $STT = 1;
                                //  Bắt đầu vòng lặp
