...
<?php require_once 'php/Them_TK_SV.php' ?>
    ...
    <h4 class="m-0 font-weight-bold text-primary">Tài khoản sinh viên</h4>
    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style = "text-align: center;">
        <tr>
            ...
            <?php
                 $STT = 1;
                 $sql = "SELECT tk.TenTaiKhoan, tk.MatKhau, sv.HoVaTen, sv.GioiTinh, sv.TrangThai FROM taikhoan tk, sinhvien sv WHERE sv.MSSV = tk.TenTaiKhoan AND VaiTro = 'SinhVien'";
                ...
                <tr>
                    ...
                    <td> 
                      <a class='btn btn-info btn-sm' href='TaiKhoanSV.php?Sua=<?php echo $row['TenTaiKhoan'] ?>'> <i class='fas fa-pencil-alt'> </i> Cập nhật mật khẩu </a>
                    </td>
                </tr>
        ...
        <?php
          //if($update == true):?>
            <!-- <table style="margin-top: 300px;">
                ...
                <form class="user" method="POST" action ="php/Them_TK_SV.php">
                    <div class="form-group row">
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control-user" id="TaiKhoan"
                                placeholder="Tài khoản" name="TK" value = "<?php echo $TenTaiKhoan;?>" style="margin-left: 100px;" readonly="readonly">
                        </div>
                        <div class="col-sm-5">
