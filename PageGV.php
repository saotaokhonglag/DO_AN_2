     ...
     <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Các môn học phần mà bạn được phân công:</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" style = "text-align: center;" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                            $STT = 1;
                            $sql = "SELECT lh.MaLopHP, lh.TenLop, pc.HocKi, pc.NamHoc
                            ...
                            <tr>
                                ...
                                <td> 
                                <a class="btn btn-info btn-sm" href="DSSV.php?DS=<?php echo $row['MaLopHP']?>"> <i class='fas fa-list'> </i> Danh sách </a>
                                </td>
                            </tr>
                        <?php endwhile?>
